...
const handleSubmit=async (e)=>{
  ...
  <form onSubmit={handleSubmit} >
    ...
    <div className="form-check form-check-inline formcustom0">
      ...
      <input type="Number"  className="form-control formcustom0" id="Number" placeholder="Enter Your Mobile Number" name="Ph" onChange={handleChange}  />
    </div>

    <div className="form-group formcustom0">
      <label htmlFor="DOB">Date of Birth</label>
      <input type="date" className="form-control formcustom0" id="DOB" name="DOB"  onChange={handleChange} />
    </div>
