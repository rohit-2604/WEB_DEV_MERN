  ...
  return (
    <div className="container mt-5">
      <div className="card mx-auto formcustom0" style={{ maxWidth: '400px' }}>
        <div className="card-header cardcustom ">
        ...
        <div className="card-body text-center">
          {user && (
            <>
              ...
              <div>
                <button className="btn btn-success btn-block mt-3 shadow" onClick={handleAddProfile}>Add New User</button>
                <button className="btn btn-success btn-block mt-3 shadow mx-2" onClick={handleListProfile}>Total User List</button>
              </div>
              <div>
                <button className="btn btn-danger btn-block mt-3 shadow mx-2" onClick={handleLogout}>Logout  </button>
