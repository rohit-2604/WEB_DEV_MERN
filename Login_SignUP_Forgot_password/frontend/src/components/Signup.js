...
const handleSubmit=async (e)=>{
  ...
  <form onSubmit={handleSubmit}>
    <div className="form-group formcustom">
    ...
    <div className="form-group formcustom">
      <label className='formcustom'>Gender</label>
      <div>
        <div className="form-check form-check-inline formcustom">
          <input className="form-check-input formcustom" type="radio" name="Gender" id="male" Value="Male" onChange={handleChange}  />
      ...
      <div className="form-group formcustom0">
        ...
        <input type="file" className="form-control-file" id="image" name="image" onChange={(e) => setImage(e.target.files[0])||setImagePreview(URL.createObjectURL(e.target.files[0]))}/>
      </div>
      {imagePreview && (
              <img
                src={imagePreview}
    ...
    <div className="form-group formcustom0">
      ...
      <input type="Number" className="form-control formcustom0" id="Number" name="Ph" onChange={handleChange}  />
    </div>
    <div className="form-group formcustom0">
    ...
    <button type="submit" className="btn btn-primary mt-2 middle shadow formcustom0">Submit</button>
